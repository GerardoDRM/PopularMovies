...
public class TestProvider extends AndroidTestCase {
    ...
    public void testBasicWeatherQuery() {
        ...
        long weatherRowId = db.insert(MoviesContract.MovieEntry.TABLE_NAME, null, weatherValues);
  ...
  */
    public void testUpdateLocation() {
        ...
        updatedValues.put(MoviesContract.MovieEntry.COLUMN_TITLE, "New test");

        // Create a cursor with observer to make sure that the content provider is notifying
        // the observers as expected
        Cursor locationCursor = mContext.getContentResolver().query(MoviesContract.MovieEntry.CONTENT_URI, null, null, null, null);
